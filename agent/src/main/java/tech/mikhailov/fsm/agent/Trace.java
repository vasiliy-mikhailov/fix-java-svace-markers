...
interface Trace {
     ...
     * message, the first time that message is sent: a tool loop resends the whole conversation every
     * turn, so recording each request whole would be quadratic in the turns.
     */
