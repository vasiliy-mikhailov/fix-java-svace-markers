...
public final class ParseTest {
    ...
    public static Result parseTest(Request req) {
        ...
        // Values.text, and the distinction worth stating is NOT with Json.str — that is this same
        // function under a second name, and the two cannot disagree about anything.
