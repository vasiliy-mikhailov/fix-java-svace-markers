...
public record FsmProperties(@DefaultValue Prove prove, @DefaultValue Github github,
     ...
     * {@code n8n/docker-compose.yml}; without it this feature works on a laptop and silently no-ops on
     ...
     *            the mount: {@code n8n/docker-compose.yml} binds the repository root to {@code /data}
